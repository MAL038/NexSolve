...
type TabKey = "general" | "users" | "settings";
...
export default function OrgSettingsClient({
  ...
  async function saveOrgSettings() {
    ...
    if (!res.ok) {
      // kan object met fieldErrors zijn; gewoon tonen
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  onKeyDown={e => {
                    ...
                    if (e.key === "Escape") { setEditName(false); setOrgName(org.name); }
                  }}
      ...
      {tab === "general" && (
        <div className="card p-6 space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <div className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1">Organisatie ID</div>
              <div className="text-sm font-mono text-slate-700 break-all">{org.id}</div>
            </div>
            <div>
              <div className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1">Slug</div>
              <div className="text-sm font-mono text-slate-700">{org.slug}</div>
            </div>
            <div>
              <div className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1">Aangemaakt</div>
            ...
            <div>
              ...
              <div className={clsx(
                ...
                (org.is_active ? "bg-brand-50 text-brand-700 border-brand-200" : "bg-red-50 text-red-700 border-red-200")
              )}>
          ...
          <div className="pt-2 border-t border-slate-100">
            <div className="text-xs text-slate-500">
              Superuser kan hierna naar <b>Gebruikers</b> en <b>Instellingen</b> om alles voor deze organisatie te beheren.
            </div>
          </div>
        </div>
      )}
          ...
          {showInvite && isAdmin && (
            <div className="card p-6 border-2 border-brand-100 space-y-4">
              ...
              <div className="flex gap-3 justify-end">
                <button onClick={() => setShowInvite(false)} className="px-4 py-2 rounded-xl text-sm text-slate-500 hover:bg-slate-100">
                  Annuleren
                </button>
                <button
                  onClick={sendInvite}
            ...
            <div className="card p-6 space-y-5">
              ...
              {!isAdmin && (
                <div className="text-xs text-slate-400">
                  Je hebt geen rechten om instellingen te wijzigen.
                </div>
              )}
            </div>
          </div>
