...
import { Users, FolderKanban, Layers, Settings, ArrowRight, ShieldCheck } from "lucide-react";
  ...
  return (
    <div className="p-8 max-w-5xl mx-auto space-y-8">
      ...
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">Beheer het platform, gebruikers, themas en instellingen.</p>
      </div>
      ...
      <div className="space-y-3">
        ...
        <div className="grid gap-2">
          {[
            ...
            { href: "/admin/theemas",      icon: Layers,      label: "Themas & submodules",   sub: "Categorieen en subprocessen toevoegen of aanpassen",    color: "text-violet-500", bg: "bg-violet-50" },
